        ...
        <>
            ...
            <div className="flex justify-center items-center space-x-80 mt-4 mb-40 sm:mb-20 font-navbar">
                <Navbar fluid rounded className="bg-transparent mb-5 relative h-12 sm:h-auto w-12 sm:w-auto">
                    <Navbar.Toggle className="absolute active:bg-transparent focus:bg-transparent active:border-0 active:border-none focus:border-none left-0 top-0 h-16 sm:h-auto w-16 sm:w-auto" />
                    <Navbar.Collapse>
