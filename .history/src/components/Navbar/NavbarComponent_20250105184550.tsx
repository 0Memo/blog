    ...
    return(
        <>
            ...
            <div className="flex justify-center items-center space-x-80 mt-4 mb-20 font-navbar">
                <Navbar fluid rounded className="bg-transparent mb-5 relative h-12 w-12">
                    <Navbar.Toggle className="absolute left-0 top-0 h-16 w-16" />
                    <Navbar.Collapse>
                        <div className="flex flex-col sm:flex-row justify-center items-center sm:space-x-80 mt-8 sm:mt-0">
